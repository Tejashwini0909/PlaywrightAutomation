...
test.describe('FW Tests', () => {
  ...
  test('TC_02 - Verify gemini-2.5-pro module validation', async ({ page }) => {
    const modulepageObject = new ModulePages(page);
  ...
  // GPT-5 modules
  test('TC_03 - Verify GPT-5-Auto module validation', async ({ page }) => {
    const modulepageObject = new ModulePages(page);
  ...
  test('TC_04 - Verify GPT-5-Mini-Thinking module validation', async ({ page }) => {
    const modulepageObject = new ModulePages(page);
  ...
  test('TC_05 - Verify GPT-5-Auto Thinking validation', async ({ page }) => {
    const modulepageObject = new ModulePages(page);
  ...
  test('TC_06 - Verify GPT-5-Thinking module validation', async ({ page }) => {
    const modulepageObject = new ModulePages(page);
