...
test.describe('FW Tests', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    try {
      ...
      // Additional wait to ensure the application is fully loaded
  ...
  test('TC_01 - Verify gpt-4.1 module validation', async ({ page }) => {
    try {
      ...
      console.error('TC_01 failed:', error);
      // Take a screenshot for debugging
      await page.screenshot({ path: 'tc01-failed.png' });
      throw error;
    }
  });
  ...
  test('TC_02 - Verify grok-4 module validation', async ({ page }) => {
    try {
      ...
      console.error('TC_02 failed:', error);
      await page.screenshot({ path: 'tc02-failed.png' });
      throw error;
    }
  });
  ...
  test('TC_03 - Verify gemini-2.5-pro module validation', async ({ page }) => {
    try {
      ...
      console.error('TC_03 failed:', error);
      await page.screenshot({ path: 'tc03-failed.png' });
      throw error;
    }
  });
  ...
  test('TC_04 - Verify gpt-o3 module validation', async ({ page }) => {
    try {
      ...
      console.error('TC_04 failed:', error);
      await page.screenshot({ path: 'tc04-failed.png' });
      throw error;
    }
  });
  ...
  test('TC_05 - Verify gpt-o3-mini module validation', async ({ page }) => {
    try {
      ...
      console.error('TC_05 failed:', error);
      await page.screenshot({ path: 'tc05-failed.png' });
      throw error;
    }
  }); 
  ...
  test('TC_06 - Verify Claude 4 Sonnet module validation', async ({ page }) => {
    try {
      ...
      console.error('TC_06 failed:', error);
      await page.screenshot({ path: 'tc06-failed.png' });
      throw error;
    }
  });
  ...
  test('TC_07 - Verify DeepSeek R1 module validation', async ({ page }) => {
    try {
      ...
      console.error('TC_07 failed:', error);
      await page.screenshot({ path: 'tc07-failed.png' });
      throw error;
    }
  });
